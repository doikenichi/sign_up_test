# Sign-up form rejects Unicode first and last names in mobile-fr

## Summary

The sign-up form displays a name validation error for the Unicode first-name and last-name cases in the mobile-fr run.
...
- Evidence: [first-name error context](.playwright-work/evidence/2026-09-24T08-57-01-573Z/test-005/error-context.md), [last-name error context](.playwright-work/evidence/2026-09-24T08-57-01-573Z/test-006/error-context.md)
