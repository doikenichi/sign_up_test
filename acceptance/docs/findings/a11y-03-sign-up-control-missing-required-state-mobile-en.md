# Sign-up form controls do not expose required state in mobile-en

## Summary

At least one of the eight required controls in the sign-up form exposes neither a `required` attribute nor `aria-required="true"` in the mobile-en run.
...
- Evidence: [error context](.playwright-work/evidence/2026-09-24T08-43-04-830Z/test-001/error-context.md), [screenshot](.playwright-work/evidence/2026-09-24T08-43-04-830Z/test-001/test-failed-1.png)
...
[Failed test screenshot](.playwright-work/evidence/2026-09-24T08-43-04-830Z/test-001/test-failed-1.png)
