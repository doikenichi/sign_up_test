# Sign-up form does not show an error for an overlong phone number in mobile-fr

## Summary

The sign-up form accepts a Canadian phone value with too many digits without displaying a phone validation error in the mobile-fr run.
...
- Evidence: [error context](.playwright-work/evidence/2026-09-24T08-57-01-573Z/test-007/error-context.md)
