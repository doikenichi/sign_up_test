...
- main:
  ...
  - link "Login":
    - /url: /
  - heading "Create a nesto account" [level=2]
  - img "nesto secure"
  - group:
    - textbox "First name" [invalid]
    - text: First name The field is required
  - group:
    - textbox "Last name": Cummerata
    - text: Last name
  - group:
  ...
  - group:
    - combobox "Province of purchase":
      ...
      - option "Nunavut"
    - img
    - text: Province of purchase
  - group:
    - textbox "Email": [redacted-email]
    - text: Email
  - group:
    - textbox "Password": [redacted]
    - text: Password Password must be between 12 and 32 characters and contain one uppercase letter, one lowercase letter and one number.
  - group:
    - textbox "Confirm password": [redacted]
    - text: Confirm password
  - group:
    - checkbox "By checking this box, you agree to be contacted by nesto’s partners for the purposes of offering you financial products. You agree to nesto sharing your mortgage information with its partners. You can opt-out at any time." [checked]
    - text: By checking this box, you agree to be contacted by nesto’s partners for the purposes of offering you financial products. You agree to nesto sharing your mortgage information with its partners. You can opt-out at any time.
  - button "Create your account"
  - text: Already have an account?
  - link "Log in":
    - /url: /
  - text: . By clicking on "Create your account", I agree and consent to the
  - link "Terms of Service (opens in a new window)":
