# Sanitized evidence: phone validation

- Tests: `API-02: rejects invalid phone`, `incomplete phone`, and `phone with letters`
- Spec: `specs/api/signup/api-02-reject-missing-or-invalid-required-field.spec.ts:42`
- Request: `POST /api/accounts` with an invalid phone value
