...
- Name: api\signup\api-03-reject-malformed-or-unsupported-values.spec.ts >> API-03: Reject malformed or unsupported values >> API-03: rejects control character in lastName
