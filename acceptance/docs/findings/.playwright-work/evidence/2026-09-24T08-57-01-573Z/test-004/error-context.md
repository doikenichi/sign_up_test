...
Call log:
  ...
  - waiting for getByTestId('phoneInput')
    13 × locator resolved to <input type="tel" id="field-6" name="phone" autocomplete="tel" placeholder="Téléphone" value="+[redacted-phone]" data-testid="phoneInput" aria-labelledby="form-placeholder-field-6" class="_input__field_w8g1t_167 _input__field--has-placeholder_w8g1t_1 PhoneInputInput"/>
       - unexpected value "+[redacted-phone]"

```

```yaml
- textbox "Téléphone": +[redacted-phone]
```
