# SUNNY-01 - Populate valid fields with consent selected
...
Populate every required field, select Canada as the phone country, and accept consent. Stop before submitting the form.

## Then

The form accepts the entered values, Canada remains selected, the phone number uses the confirmed mask
`(###) ###-####`, and consent is checked. No field validation errors are shown after completing the form.
